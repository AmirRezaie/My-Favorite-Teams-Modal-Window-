...
//Change Background, Title and Paragraph For First Button
...
//Change Background, Title and Paragraph For Second Button
...
//Change Background, Title and Paragraph For Third Button
...
//Close The Modal Window, When Click On X Button
btn.addEventListener("click", function () {
  modal.classList.add("hidden");
  overlay.classList.add("hidden");
});
//Close The Modal Window, When Press 'ESC' Button On Keyboard
document.addEventListeners("keydown", function(e){
  if(e.key === "Escape"){
    modal.classList.add("hidden");
    overlay.classList.add("hidden");
  }
